...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Integer(), primary_key=True),
        sa.Column("user_id", sa.Integer(), sa.ForeignKey("users.id"), nullable=False),
        sa.Column("timeline_enabled", sa.Boolean(), server_default=sa.true()),
        sa.Column("expert_enabled", sa.Boolean(), server_default=sa.true()),
        sa.Column("account_enabled", sa.Boolean(), server_default=sa.true()),
