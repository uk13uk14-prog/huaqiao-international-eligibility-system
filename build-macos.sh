#!/bin/bash
# ============================================================
#  Huaqiao Eligibility - macOS Build Script
# ============================================================

set -e

echo "============================================================"
echo "  华侨生资格评估系统 - macOS Build"
echo "============================================================"
echo ""
...
echo "        to bypass Gatekeeper security check."
echo "============================================================"
